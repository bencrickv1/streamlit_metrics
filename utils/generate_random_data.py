...
def write_random_data_rows_multi(n_files, n):
    ...
    for i in range(1, n_files+1):
        ...
        # with open(f'generated_data/generated_data_{i}.py', 'w') as fo:

        #     fo.write('\n')
        #     fo.write('generated_data = [\n')
        ...
        #         application = generate_random_application(boundary_gdf=boundary_gdf)
                ...
                #     quotation = '"' if k in ['application_type', 'submission_date', 'local_planning_authority'] else ''
                #     fo.write(f'        "{k}": {quotation}{v}{quotation},\n')
                # fo.write('    },\n')
